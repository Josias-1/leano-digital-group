...
export const alt = "Leano Digital Group — Azure, AI and data delivery";
      ...
      <div style={{ background: "#020617", color: "#f8fafc", display: "flex", height: "100%", width: "100%", padding: "72px", position: "relative" }}>
        <div style={{ border: "2px solid #38bdf8", borderRadius: "28px", display: "flex", height: "100%", padding: "54px", position: "relative", width: "100%" }}>
          <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", width: "100%" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", maxWidth: "860px" }}><span style={{ fontSize: 62, fontWeight: 700, letterSpacing: "-0.05em", lineHeight: 1.05 }}>Technology delivery for complex business teams.</span><span style={{ color: "#94a3b8", fontSize: 28, marginTop: "28px" }}>Azure · AI · Data Engineering</span></div>
